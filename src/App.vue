  ...
  <div class="app-content">
    ...
    <footer>
      <p>
        Created by
        <span class="username"
          ><a href="https://twitter.com/developerBolu">Boluwatife</a></span
        >
        -
        <span class="devchallenges"
          ><a href="https://devchallenges.io">devChallenges.io</a></span
        >
      </p>
    </footer>
    <!-- SEARCH HOTELS MODAL -->
    <teleport to="#app">
      <div class="search-modal" v-if="openSearchModal">
        <div class="modal">
          <header>
